...
- [x] [Serve](../ref/serve.md) (private node-scoped tailnet Serve and policy-gated service-host workflows are supported, with integration coverage for HTTP/TCP and service-host mode matrix; full hosted-product parity remains partial) ([#1921](https://github.com/juanfont/headscale/issues/1921))
