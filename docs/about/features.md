...
- [ ] [Funnel](https://tailscale.com/kb/1223/funnel) ([#1040](https://github.com/juanfont/headscale/issues/1040)) (capability, allow-ports, and per-node policy targeting are implemented; managed public-ingress parity remains open)
- [x] [Serve](../ref/serve.md) (private node-scoped tailnet Serve and policy-gated service-host workflows are supported, with integration coverage for HTTP/TCP/TLS-terminated node-scoped modes and service-host policy transitions; full hosted-product parity remains partial) ([#1921](https://github.com/juanfont/headscale/issues/1921))
