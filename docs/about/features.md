...
- [x] [Serve](../ref/serve.md) (private node-scoped tailnet Serve is supported, Funnel is partial, and service-host support is still incomplete) ([#1921](https://github.com/juanfont/headscale/issues/1921))
